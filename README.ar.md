...
```
دالة حمل_للمعالج ()؛
دالة حمل_للمعالج (مسار_الملف_التشغيلي: مـؤشر_محارف)؛
```
...
تحميل المشغل الخاص بالمعالج المركزي. استخدم هذه الدالة قبل التهيئة. هذا المشغل مسؤول عن تشغيل عملية
الاستدلال على المعالج المركزي.
الصيغة الأولى تبحث عن المشغلات تلقائيا في المسار الحالي وفي مسار مكتبة `جـجمل`، وهذا ما يتيح العثور
على المشغل في حالة التشغيل المباشر أو الترجمة المسبقة لمشروعك. لكن يمكنك تحديد مسارك الخاص باستخدام
الصيغة الثانية، والتي تبحث عن المشغل في المسار المعطى فقط. في الغالب الصيغة الأولى من الدالة كافية
لكن الصيغة الثانية متوفرة للحالات الاستثنائية.

#### حمل_لفلكان (vkLoad)

```
دالة حمل_لفلكان ()؛
دالة حمل_لفلكان (مسار_الملف_التشغيلي: مـؤشر_محارف)؛
```
...
تحميل المشغل الخاص بواجهة فلكان (Vulkan). استخدم هذه الدالة بدلا من `حمل_للمعالج` قبل التهيئة إذا
أردت استخدام معالج الرسوم.
الصيغة الأولى تبحث عن المشغلات تلقائيا في المسار الحالي وفي مسار مكتبة `جـجمل`، وهذا ما يتيح العثور
على المشغل في حالة التشغيل المباشر أو الترجمة المسبقة لمشروعك. لكن يمكنك تحديد مسارك الخاص باستخدام
الصيغة الثانية، والتي تبحث عن المشغل في المسار المعطى فقط. في الغالب الصيغة الأولى من الدالة كافية
لكن الصيغة الثانية متوفرة للحالات الاستثنائية.
