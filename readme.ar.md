...
| `حرر`                     | `(سياق: سند[سـياق])`                                      |
| `هيئ_نوما`                | `(إستراتيجية_نوما: إسـتراتيجية_نوما)`                     |
| `أهو_نوما`                | `(): ثنائي`                                               |
| `هات_تكلفة_الموتر`        | `(): طـبيعي_متكيف`                                        |
| `هات_حجم_النوع`           | `(نوع: نـوع): طـبيعي_متكيف`                               |
| `هات_حجم_الصف`            | `(نوع: نـوع، ب_ع: صحيح[64]): طـبيعي_متكيف`                |
...
| `حول_نوع_بنية_إلى_نوع`    | `(نوع_بنية: نـوع_بنية): نـوع`                             |
| `حول_الحالة_لنص`          | `(حالة: حـالة): مؤشر_محارف`                               |
...
### سرد `إسـتراتيجية_نوما` (`NumaStrategy`)
...
| الدالة                        | الصنف                                                 |
|-------------------------------|-------------------------------------------------------|
| `أنشئ_موترا`                  | `(نوع: نـوع، ب_ع0: صحيح[64]): سند[مـوتر]`             |
| `أنشئ_موترا`                  | `(نوع: نـوع، ب_ع0: صحيح[64]،`                         |
|                               | ` ب_ع1: صحيح[64]): سند[مـوتر]`                        |
| `أنشئ_موترا`                  | `(نوع: نـوع، ب_ع0-2: صحيح[64]): سند[مـوتر]`           |
| `أنشئ_موترا`                  | `(نوع: نـوع، ب_ع0-3: صحيح[64]): سند[مـوتر]`           |
...
| `شغل_البيان`                  | `(بيان: سند[بـيان]، عدد_المسالك: صحيح): حـالة`        |
...
| الدالة                    | الصنف                                             |
|---------------------------|---------------------------------------------------|
| `حمل`                     | `(مسار: مؤشر_محارف): سند[سـجل]` (مشتركة)          |
| `حمل_للمعالج`             | `()` (مشتركة)                                     |
| `حمل_لفلكان`              | `()` (مشتركة)                                     |
...
| `شغل_البيان`              | `(بيان: سند[بـيان]): حـالة`                       |
| `شغل_البيان_بالتوازي`     | `(بيان: سند[بـيان]): حـالة`                       |
